...
class GeneralQuestion extends React.Component {
  ...
  onValueChange(event) {
    ...
    var result = this.props.data.questionsren.options.find((obj) => {
      return obj.option === event.target.value;
    });
    var data1 = {
      identifier: this.props.data.questionsren.identifier,
                        ...
                        <ul>
                          <li>
                            <input
                              type="radio"
                              id={opt[i]}
                              value={questiontemp.options[i]["option"]}
                              name="selector"
                              checked={
                                this.state.selectedOption === ""
                                  ? false
                                  : this.state.selectedOption ===
                                    questiontemp.options[i]["option"]
                              }
                          ...
                          <li>
                            <input
                              ...
                              checked={
                                this.state.selectedOption === ""
                                  ? false
                                  : this.state.selectedOption === item["option"]
                              }
                              onChange={this.onValueChange}
                            />
                            <label
  ...
  componentDidMount() {
    ...
    userService.getSavedStudentResponse(data).then(
      (studentresponse) => {
        ...
        if (
          studentresponse.Option !== "" &&
          this.props.data.questionsren.hasOwnProperty("options")
        ) {
          var data1 = this.state.data1;
          var result = this.props.data.questionsren.options.find((obj) => {
            return obj.option === studentresponse.Option;
          });
